...
-__http://localhost:8080/api/libro/lista__ -> para ver todos los libros <br>
-__http://localhost:8080/apI/libro/buscar/{id}__-> si quiere buscar un libro en particular <br>
